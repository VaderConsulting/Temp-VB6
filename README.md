...
|---------|----------|------|---------|
| `Project1` (`Project1.vbp`) | VB6 | WinForms exe | Scratch XML merge / ScriptControl experiments |
...
Working copy from Dave Robinson's OneDrive Historical Dev folder `VB/Temp`.
